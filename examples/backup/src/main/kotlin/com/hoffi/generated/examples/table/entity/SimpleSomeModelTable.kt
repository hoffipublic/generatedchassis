...
/**
 * table model: SomeModel
 * with dslRef: disc:simpleEntities|modelgroup:Entitygroup|model:SomeModel|table
 * generated at DEVTIME on macbook-pro.fritz.box
 */
@TABLEsDTO(
  SimpleSomeModelTable::class,
  targetDto = SimpleSomeModelDto::class,
)
public object SimpleSomeModelTable : UuidTable("simple_some_model"), WasGenerated {
